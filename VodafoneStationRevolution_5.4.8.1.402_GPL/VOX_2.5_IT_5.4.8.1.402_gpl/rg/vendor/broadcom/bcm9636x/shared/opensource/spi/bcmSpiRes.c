...
#ifdef CONFIG_HW_YWZ00A
static struct flash_platform_data hs_spi_flash = {
    .type = "mx25l128",
};
#endif
...
#ifdef CONFIG_HW_YWZ00A
        .modalias        = "m25p80",
        .platform_data   = &hs_spi_flash,
#elif  defined (CONFIG_HW_HG558)
        .modalias        = "spi:hx8347b-lcd",
#else
