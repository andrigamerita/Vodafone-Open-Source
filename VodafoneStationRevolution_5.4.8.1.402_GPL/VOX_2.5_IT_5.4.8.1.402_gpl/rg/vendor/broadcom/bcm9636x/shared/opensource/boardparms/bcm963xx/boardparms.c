...
enum bp_id {
  ...
  bp_usGpioDSLAnnexFilter,
  bp_ucProximitySensorAddress, /* proximity sensor i2c address */
  bp_usProximitySensorSDA, /* proximity sensor i2c SDA gpio */
  bp_usProximitySensorSCL, /* proximity sensor i2c SCL gpio */
  bp_last
};
...
static bp_elem_t g_bcm963168vx[] = {
    ...
    {bp_ulGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       ...
                                       BP_OVERLAY_USB_DEVICE)},
#ifdef CONFIG_RG_HW_BUTTONS_FEATURE
  {bp_usGpioBtnRst, .u.us = BP_GPIO_32_AL},
  {bp_usGpioBtnWps, .u.us = BP_GPIO_33_AL},
#endif
    {bp_usAntInUseWireless,      .u.us = BP_WLAN_ANT_MAIN},
    {bp_usWirelessFlags,         .u.us = 0},
    ...
    {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
    {bp_ucDspAddress,            .u.uc = 0},
    {bp_ucDspType1,              .u.uc = BP_VOIP_NO_DSP},
...
//PegatronCVP6, Frederick 20131220, add ADB profile 
static bp_elem_t g_adbvox25[] = {
  {bp_cpBoardId,               .u.cp = "963168_ADBVOX25"},	  
  ...
  {bp_usGpioUart2Sdin,         .u.us = BP_GPIO_12_AH},
  {bp_usGpioUart2Sdout,        .u.us = BP_GPIO_13_AH}, 
  {bp_ucProximitySensorAddress,.u.uc = 0x1c },
  {bp_usProximitySensorSDA,    .u.us = BP_GPIO_9_AH },
  {bp_usProximitySensorSCL,    .u.us = BP_GPIO_8_AH },
  {bp_last}
};
...
static bp_elem_t * g_BoardParms[] = {g_bcm963268sv1, g_bcm963268mbv, g_bcm963168vx, g_bcm963168vx_p300, g_bcm963268bu, g_bcm963268bu_p300,
		...
		g_bcm963168vx_p400, g_bcm963168vx_ext1p8, g_bcm963168ach5, g_bcm963168ac5, g_bcm963168xn5, g_bcm963168xm5, g_bcm963168xm5_6302, g_bcm963168wfar,
		g_adbvox25, 0};
...
static WLAN_SROM_ENTRY wlan_patch_unique_96362RADVNXH5[] = {
    {2,  0x63F},
//PegatronCVP, Frederick 20140212 broadcom wlan patch
    {48, 0x434f},
    {65, 0x1100},
    {0, 0}
};
...
//PegatronCVP6, Frederick, 20130106 add patches for wifi 
static WLAN_SROM_ENTRY wlan_patch_common_963268MBV_VOX25[] = {
    { 78,  0x0303}, 
    { 79,  0x0202}, 
    { 80,  0xff02},
    { 87,  0x0315}, 
    ...
    { 162, 0xBBBB},
    #else
	{ 160, 0x0000}, //2G Band CCK power offsets
    { 161, 0x0000}, //2G Band 20 MHz Legacy rates (18, 12, 9, 6) and mcs0-2 SISO OFDM power offsets
    { 162, 0x0000}, //2G Band 20 MHz Legacy rates (54, 48, 36, 24) and mcs3-7 SISO OFDM power offsets
	#endif
    { 163, 0x0000},
    { 164, 0x0000},
    { 165, 0x0000},
	...
	{ 176, 0xBBBB},
	#else
    { 169, 0x0000}, //2G Band 11n 20 MHz MCS 0-3 pre-CDD/pre-STBC power offsets
    { 170, 0x0000}, //2G Band 11n 20 MHz MCS 4-7 pre-CDD/pre-STBC power offsets
    { 171, 0x6666}, //2G Band 11n 20 MHz MCS 8-11 SDM power offsets
    { 172, 0x6666}, //2G Band 11n 20 MHz MCS 12-15 SDM power offsets
	{ 173, 0x0000}, //2G Band 11n 40 MHz MCS 0-3 SISO/pre-CDD/pre-STBC/pre-bw40po power offsets
	{ 174, 0x0000}, //2G Band 11n 40 MHz MCS 4-7 SISO/pre-CDD/pre-STBC/pre-bw40po power offsets
	{ 175, 0x4444}, //2G Band 11n 40 MHz MCS 8-11 pre-bw40po SDM power offsets
	{ 176, 0x4444}, //2G Band 11n 40 MHz MCS 12-15 pre-bw40po SDM power offsets
	#endif
    { 177, 0x0000},
    { 178, 0x0000},
    { 179, 0x0000},
...
static WLAN_SROM_ENTRY wlan_patch_unique_bcm4360[] = {
    {0, 0}
};


static WLAN_SROM_ENTRY wlan_patch_common_bcm4360_VOX25[] = {
	//Antenna Chain number 0
	{ 114,	0x5454}, 
	{ 115,	0x5454}, 
	//Band range: PA Parameters for 5G LOW BAND

	{ 116,  0xff48}, //pa5gb0w0a0 [a1]
	{ 117,  0x15be}, //pa5gb0w1a0 [b0]
	{ 118,  0xfd2a}, //pa5gb0w2a0 [b1]
	//Band range: PA Parameters for 5G MID BAND
	{ 119,  0xff39}, //pa5gb1w0a0 [a1]
	{ 120,	0x14f8}, //pa5gb1w1a0 [b0]
	{ 121,	0xfd3f}, //pa5gb1w2a0 [b1]
	//Band range: PA Parameters for 5G HIGH BAND
	{ 122,	0xff3b}, //pa5gb2w0a0 [a1]
	{ 123,	0x15fc}, //pa5gb2w1a0 [b0]
	{ 124,  0xfd24}, //pa5gb2w2a0 [b1]
	//Band range: PA Parameters for 5G V2 X1 BAND
	{ 125,  0xff46}, //pa5gb3w0a0 [a1]
	{ 126,  0x1647}, //pa5gb3w1a0 [b0]
	{ 127,  0xfd31}, //pa5gb3w2a0 [b1]
	
	//Antenna Chain number 1
	{ 134,	0x5454}, 
	{ 135,	0x5454}, 

	
	//Band range: PA Parameters for 5G LOW BAND
	{ 136,  0xff0c}, //pa5gb0w0a1 [a1]
	{ 137,  0x1384}, //pa5gb0w1a1 [b0]
	{ 138,  0xfd45}, //pa5gb0w2a1 [b1]
	//Band range: PA Parameters for 5G MID BAND
	{ 139,  0xff15}, //pa5gb1w0a1 [a1]
	{ 140,	0x13af}, //pa5gb1w1a1 [b0]
	{ 141,	0xfd4b}, //pa5gb1w2a1 [b1]
	//Band range: PA Parameters for 5G HIGH BAND
	{ 142,	0xff25}, //pa5gb2w0a1 [a1]
	{ 143,	0x1540}, //pa5gb2w1a1 [b0]
	{ 144,  0xfd2d}, //pa5gb2w2a1 [b1]
	//Band range: PA Parameters for 5G V2 X1 BAND
	{ 145,  0xff39}, //pa5gb3w0a1 [a1]
	{ 146,  0x1600}, //pa5gb3w1a1 [b0]
	{ 147,  0xfd2e}, //pa5gb3w2a1 [b1]
	
	//Antenna Chain number 2
	
	{ 154,	0x5454}, 
	{ 155,	0x5454}, 
	//Band range: PA Parameters for 5G LOW BAND
	{ 156,  0xff62}, //pa5gb0w0a2 [a1]
	{ 157,  0x1639}, //pa5gb0w1a2 [b0]
	{ 158,  0xfd41}, //pa5gb0w2a2 [b1]
	//Band range: PA Parameters for 5G MID BAND
	{ 159,  0xff74}, //pa5gb1w0a2 [a1]
	{ 160,	0x1698}, //pa5gb1w1a2 [b0]
	{ 161,	0xfd4f}, //pa5gb1w2a2 [b1]
	//Band range: PA Parameters for 5G HIGH BAND
	{ 162,	0xff45}, //pa5gb2w0a2 [a1]
	{ 163,	0x1667}, //pa5gb2w1a2 [b0]
	{ 164,  0xfd26}, //pa5gb2w2a2 [b1]
	//Band range: PA Parameters for 5G V2 X1 BAND
	{ 165,  0xff65}, //pa5gb3w0a2 [a1]
	{ 166,  0x1759}, //pa5gb3w1a2 [b0]
	{ 167,  0xfd31}, //pa5gb3w2a2 [b1]
};


//PegatronCVP6, Frederick, end add patches for wifi
...
#if 1//defined(UNIHAN_PRODUCT_VOX25)
	{ 97,  0xff55}, 
    { 98,  0x15ac},
    { 99,  0xfaff},
#endif  //#if defined(UNIHAN_PRODUCT_VOX25)
    { 100, 0x3E40},
    { 101, 0x403C},
    { 102, 0xFF15},
    { 103, 0x1455},
...
//PegatronCVP, Fredeirck, 20140210 patch for new wlan driver
    {"963168WFAR",    0x6362, 220, wlan_patch_unique_963268MBV,     wlan_patch_common_963268MBV},
//PegatronCVP, 20140106 Frederick  add patches for wlan
	{"963168_ADBVOX25",	0x6362, 220, wlan_patch_unique_963268MBV,     wlan_patch_common_963268MBV_VOX25},
	{"963168_ADBVOX25",	0x4360, 234, wlan_patch_unique_bcm4360,     wlan_patch_common_bcm4360_VOX25},
#endif
...
//PegatrconCVP, Frederick, 20140210 bcm patch for wlan 
...
//PegatrconCVP, Frederick, 20140210 bcm patch for wlan 
    ...
    {"",       0,      0}}},
//PegatronCVP, 20140106 Frederick  add patches for wlan
/* this is the patch to boardtype(boardid) for ADBVOX2-5. */
    {"963168_ADBVOX25", 0x435f14e4, 64,		
    {{"subpciids", 11, 0x5BB14e4},
    {"",       0,      0}}},
#endif
    {"",                 0, 0, {{"",       0,      0}}}, /* last entry*/
...
int BpGetBtnRstGpio(unsigned short *pusValue)
{
    return BpGetGpio(bp_usGpioBtnRst, pusValue);
}

int BpGetDSLAnnexFilterGpio(unsigned short *pusValue)
{
    return BpGetGpio(bp_usGpioDSLAnnexFilter, pusValue);
}

int BpGetBtnWpsGpio(unsigned short *pusValue)
{
    return BpGetGpio(bp_usGpioBtnWps, pusValue);
}

int BpGetProximitySensorSlaveAddress(unsigned char *pucValue)
{
    return BpGetUc(bp_ucProximitySensorAddress, pucValue);
}

int BpGetProximitySensorSDAGpio(unsigned short *pusValue)
{
    return BpGetGpio(bp_usProximitySensorSDA, pusValue);
}

int BpGetProximitySensorSCLGpio(unsigned short *pusValue)
{
    return BpGetGpio(bp_usProximitySensorSCL, pusValue);
}
