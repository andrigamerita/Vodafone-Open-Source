...
#define XTMCFGIOCTL_OPEN_CONNECTION \
    _IOWR(XTMCFGDRV_MAJOR, 17, XTMCFGDRV_PTMBONDINGCFG)
#define XTMCFGIOCTL_CLOSE_CONNECTION \
    _IOWR(XTMCFGDRV_MAJOR, 18, XTMCFGDRV_PTMBONDINGCFG)
...
typedef struct
{
    XTM_ADDR ConnAddr;
    BCMXTM_STATUS bxStatus;
} XTMCFGDRV_CONNECTION_INFO, *PXTMCFGDRV_CONNECTION_INFO;
