...
void fap4keBpm_flushFreeCache( void );
int fap4keBpm_flushFreeCache_done( void );
int fap4keBpm_freeCacheSlot_avail( void );
...
void fap4keBpm_setStatus( int status );
void fap4keBpm_init( void );
#if defined(CC_FAP_BPM_EXT_FREE)
void fap4keBpm_extFreeBuf_wr(uint16 numBufs, uint32 memAddr);
void fap4keBpm_extFreeBuf_rd( uint16 numBufs );
#endif
