...
BCMXTM_STATUS BcmXtm_SendOamCell( PXTM_ADDR *ppConnAddr,
    PXTM_OAM_CELL_INFO pOamCellInfo, int bNonBlocking);
...
BCMXTM_STATUS BcmXtm_OpenConnection( PXTM_ADDR pConnAddr );
BCMXTM_STATUS BcmXtm_CloseConnection( PXTM_ADDR pConnAddr );
