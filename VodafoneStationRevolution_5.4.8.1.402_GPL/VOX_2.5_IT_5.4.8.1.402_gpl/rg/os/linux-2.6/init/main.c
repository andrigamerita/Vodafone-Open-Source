...
#if defined(CONFIG_BROADCOM_9338X)
...
int silent_serial = 0;
static int __init silent_serial_setup(char *str)
{
        silent_serial = 1;
}
__setup("silent_serial", silent_serial_setup);
EXPORT_SYMBOL(silent_serial);
...
unsigned long is_network_boot;
EXPORT_SYMBOL(is_network_boot);
