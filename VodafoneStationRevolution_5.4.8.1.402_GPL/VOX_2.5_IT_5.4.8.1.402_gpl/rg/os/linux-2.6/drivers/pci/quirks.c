...
static void __devinit quirk_via6212_uhci(struct pci_dev *dev)
{
	dev->resource[4].start = dev->resource[4].start | KSEG1;
	dev->resource[4].end = dev->resource[4].end | KSEG1;	
}
DECLARE_PCI_FIXUP_FINAL(PCI_VENDOR_ID_VIA, PCI_DEVICE_ID_VIA_82C586_2, quirk_via6212_uhci);
