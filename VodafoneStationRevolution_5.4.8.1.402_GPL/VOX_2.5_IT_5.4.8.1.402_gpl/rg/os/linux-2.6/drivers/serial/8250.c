...
/* kernel command argument passed by bootloader */
extern int silent_serial;
...
static int serial8250_startup(struct uart_port *port)
{
	 ...
	 */
#if !defined(CONFIG_SERIAL_8250_COMCERTO) && !defined(CONFIG_ARCH_M821XX)
...
#  error CONFIG_SERIAL_8250_RUNTIME_UARTS must be less or equal than CONFIG_SERIAL_8250_RUNTIME_UARTS
#endif
