...
/* XXX If this enum changes, make sure you update the corresponding 
 * definition in pkg/lpd/lpd.c
 */
...
#if defined(DEVELOPER) || defined(CONFIG_RG_LPD) || defined(ENABLE_BUILD_FARM_HACKS)
