...
#define ADD_QDISC_LIST(qdisc) { \
    extern struct qdisc_util qdisc; \
    qdisc.next = qdisc_list; \
    qdisc_list = &qdisc; \
}

#define ADD_FILTER_LIST(filter) { \
    extern struct filter_util filter; \
    filter.next = filter_list; \
    filter_list = &filter; \
}

	ADD_QDISC_LIST(cbq_qdisc_util);
	ADD_QDISC_LIST(red_qdisc_util);
	ADD_QDISC_LIST(gred_qdisc_util);
	ADD_QDISC_LIST(sfq_qdisc_util);
	ADD_QDISC_LIST(ingress_qdisc_util);
	ADD_QDISC_LIST(prio_qdisc_util);
	ADD_QDISC_LIST(bfifo_qdisc_util);
	ADD_QDISC_LIST(pfifo_qdisc_util);
	ADD_QDISC_LIST(htb_qdisc_util);
	ADD_QDISC_LIST(htb2_qdisc_util);
	ADD_QDISC_LIST(pfifo_fast_qdisc_util);
	ADD_QDISC_LIST(tbf_qdisc_util);
	ADD_QDISC_LIST(wrr_qdisc_util);

	ADD_FILTER_LIST(fw_filter_util);
	ADD_FILTER_LIST(route_filter_util);
	ADD_FILTER_LIST(rsvp_filter_util);
	ADD_FILTER_LIST(tcindex_filter_util);
	ADD_FILTER_LIST(u32_filter_util);
