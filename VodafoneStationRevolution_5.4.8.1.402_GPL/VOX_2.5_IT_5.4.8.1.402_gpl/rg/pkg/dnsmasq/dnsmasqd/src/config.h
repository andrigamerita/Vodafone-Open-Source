...
#define FORWARD_FAIL_DIVISOR 2 /* Reduce queue length on divisor when query timeout limit reached */
#define FORWARD_FAIL_LIMIT 25 /* Reduce queue length when query timeout limit reached */
