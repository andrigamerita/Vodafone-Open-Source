...
/* UPNP */
#define UPNP_DEFAULT_DEVICE_TITLE JUNGO_NAME " OpenRG Internet Gateway Device"
#define UPNP_DEFAULT_MODEL_NAME "OpenRG_IGD"
...
#define SYSTEM_CPU_AFFINITY_NBITS (8)
#define SYSTEM_CPU_AFFINITY(flags) (((flags) >> 16) & 0xff)
#define SYSTEM_CPU(n) (1 << (16 + (n & 0x07)))

#define SETFD_END -1
#define SETFD_DEV_NULL -2
#define SETFD_CLOSE -3
...
#define GRP_RESTRICTED_LAN_BLOCK_PORTS "restricted_lan_block_ports"
...
#define GRP_INTERCEPTION_NAT_IN_IPV4 "interception_nat_in_ipv4"
#define GRP_INTERCEPTION_NAT_IN_IPV6 "interception_nat_in_ipv6"
#define GRP_VOIP_TEMPLATE_EXT   "voip_template_ext"
#define GRP_PINHOLES_IPV6       Spinholes "_" Sipv6
#define GRP_PINHOLES_IPV4       Spinholes "_" Sipv4
...
/* Super WiFi */
#define GRP_SUPER_WIFI		"super_wifi"
...
#define INTERCEPTION_IPV6_IP "fd00::1"
#define DNS_ALIASING_IPV6_POOL_START_IP "fd00::2"
#define DNS_ALIASING_IPV6_POOL_END_IP "fd00::00ff"
...
/* IPTV DNS forwarding */
#define IPTV_PRIMARY_DNS_IP 0x010101DF /* 1.1.1.223, host order */
#define IPTV_SECONDARY_DNS_IP 0x010101E0 /* 1.1.1.224, host order */
