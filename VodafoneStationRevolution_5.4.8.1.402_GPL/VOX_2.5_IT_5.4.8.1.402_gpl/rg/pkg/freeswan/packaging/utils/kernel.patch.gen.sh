#!/bin/bash
#
# RCSID $Id: kernel.patch.gen.sh,v 1.1.1.1 2003/02/19 11:46:31 sergey Exp $
...
echo found $i
echo "RCSID \$Id: kernel.patch.gen.sh,v 1.1.1.1 2003/02/19 11:46:31 sergey Exp $" >$patchdir/$l
