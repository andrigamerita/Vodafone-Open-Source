...
struct ipsec_sa 	                        
{
	...
	__u64*		ips_sens_integ_bitmap;
 	...
 	struct ipsec_alg_joint *ips_alg_joint;
#endif	

#ifdef CONFIG_IPSEC_USE_IXP4XX_OLD_CRYPTO
...
#endif /* CONFIG_IPSEC_USE_IXP4XX_OLD_CRYPTO */
};
...
/*
 * $Log$
 * Revision 1.12.2.1  2007/11/19 13:51:33  sergey
 * B52276: add Mindspeed's HW acceleration to RG's IPSec.
 *
 * Revision 1.12  2007/07/11 09:36:16  rotem
 * B47905 merge back into the product joint api ipsec (without linux-2.6 IXP implementations) - reviews R43621 R43622 R43774
 *
