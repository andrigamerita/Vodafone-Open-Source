...
#define dpkg_trivial_usage \
	"[-ilCEPru] [-F option] package_name"
#define dpkg_full_usage \
	"dpkg is a utility to install, remove and manage Debian packages.\n\n" \
	"Options:\n" \
	"\t-i\t\tInstall the package\n" \
	"\t-l\t\tList of installed packages or specified package\n" \
	"\t-C\t\tConfigure an unpackaged package\n" \
        "\t-E\t\tSkip packages which have the same version installed\n" \
...
#define ping_full_usage \
	...
	"Options:\n" \
	"\t-I IP/INTERFACE\tSend from the specified IP/INTERFACE.\n" \
...
#endif
#ifdef CONFIG_FEATURE_TFTP_MARK
  #ifdef CONFIG_RG_VODAFONE_IT
    #define MARK_VF_IT_VOICE "voice"
    #define TFTP_PREDEFINED_MARKS "|" MARK_VF_IT_VOICE
  #elif defined(CONFIG_RG_VODAFONE_UK)
    #define MARK_VF_UK_VOICE "voice"
    #define TFTP_PREDEFINED_MARKS "|" MARK_VF_UK_VOICE
  #else
    #define TFTP_PREDEFINED_MARKS
  #endif
  #define USAGE_TFTP_MARK(a) a
#else
  #define USAGE_TFTP_MARK(a)
#endif
...
#define tftp_full_usage \
	...
	USAGE_TFTP_MARK( \
	"\n\t-z NUM" TFTP_PREDEFINED_MARKS "\tmark packets for specific device" \
	)
...
#define top_full_usage \
	...
	"The utility exits after printing the info <times> times (default: run forever).\n" \
