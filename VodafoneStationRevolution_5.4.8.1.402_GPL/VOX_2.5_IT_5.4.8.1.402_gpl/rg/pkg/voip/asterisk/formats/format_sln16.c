...
#define BUF_SIZE 640		/* 640 samples */
...
static char *name = "sln16";
static char *desc = "Raw Signed Linear Audio support (SLN16)";
static char *exts = "sln16";
...
static struct ast_filestream *slinear_open(FILE *f)
{
	...
	if ((tmp = malloc(sizeof(struct ast_filestream)))) {
		...
		tmp->fr.subclass = AST_FORMAT_SLINEAR16;
...
int load_module()
{
	return ast_format_register(name, exts, AST_FORMAT_SLINEAR16,
								slinear_open,
								slinear_rewrite,
								slinear_write,
								slinear_seek,
