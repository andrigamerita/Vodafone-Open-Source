...
int ast_pbx_outgoing_exten(const char *type, const struct ast_codec_pref *formats, void *data, int timeout, const char *context, const char *exten, int priority, int *reason, int sync, const char *cid_num, const char *cid_name, struct ast_variable *vars, struct ast_channel **locked_channel);
...
extern void pbx_builtin_set_int_var_helper(struct ast_channel *chan, const char *name,
	const int value);
