...
/* Set default skb->mark for dns sockets */
...
/*! 
 * \brief Calculate and upadte the md5 digest of a conf file.
 * \param filename Config file name (ie: "sip.conf").
 * \param saved_md5 MD5 digest to compare to and update.
 *
 * \return 1 iff saved_md5 differs from the calculated digest of 'filename'.
 */
