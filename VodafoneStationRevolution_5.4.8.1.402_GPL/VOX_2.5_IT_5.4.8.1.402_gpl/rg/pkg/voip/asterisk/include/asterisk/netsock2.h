...
/* Reserve space for brackets: [IPv6] */
...
/*!
 * \brief
 * Parses an IPv4 or IPv6 address string without port.
 *
 * \retval 1 Success
 * \retval 0 Failure
 */
...
/*!
 * \brief
 * Resolves host and returns first address.
 */
...
/*!
 * \brief
 * Returns address family for specified address.
 */
...
/*!
 * \brief
 * Converts a struct sockaddr_storage to struct ast_sockaddr.
 */
...
/*!
 * \brief
 * Converts a struct ast_sockaddr to a string.
 */
