...
extern void ast_srv_set_ttl(struct srv_context **context, int ttl);

/*!\brief Cleanup resources associated with ast_srv_lookup
 * \param context Pointer passed into ast_srv_lookup
 */
extern void ast_srv_context_free_list(struct srv_context *context);
extern int is_srv_context_valid(struct srv_context *context);
