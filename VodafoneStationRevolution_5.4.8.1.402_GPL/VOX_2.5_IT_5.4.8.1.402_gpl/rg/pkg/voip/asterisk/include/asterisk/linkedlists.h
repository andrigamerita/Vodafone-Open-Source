...
/*!
  \brief Removes the \a current entry from a list and appends it to the end of
  another list starting with newhead.
  \param head This is a pointer to the original list head structure
  \param newhead This is a pointer to the target list head structure
  \param field This is the name of the field (declared using AST_LIST_ENTRY())
  used to link entries of this list together.

  \note This macro can \b only be used inside an AST_LIST_TRAVERSE_SAFE_BEGIN()
  block. It is a new addition originated in Asterisk 1.8.
*/
#define AST_LIST_MOVE_CURRENT(head, newhead, field) do { \
