...
/* Replace any sequence of 'min_len_to_hide' digits or more with 'x' */
extern char *logger_hide_numbers(char *str, int min_len_to_hide);

/* Replace c with 'x' if it is a digit and hiding is enabled */
extern char logger_hide_number(char c);
...
#undef LOG_MFT_INFO
#endif
#define __LOG_MFT_INFO 7
#define LOG_MFT_INFO __LOG_MFT_INFO, _A_
