...
#endif 
	_cword UserUserDataLength;
	_cword UserUserProtocol;
	_cstruct UserUserInfo;
...
#define FACILITY_RESP_FACILITYRESPONSEPARAMETER(x) ((x)->FacilityResponseParameters)
		 /* Facility-depending parameters */
#define FACILITY_RESP_INFO(x) ((x)->Info)
		 /* 0: request accepted */
		 /* 0x2001: message not supported in current state */
		 /* 0x2002: incorrect Controller/PLCI/NCCI */
		 /* 0x2007: illegal message parameter coding */
