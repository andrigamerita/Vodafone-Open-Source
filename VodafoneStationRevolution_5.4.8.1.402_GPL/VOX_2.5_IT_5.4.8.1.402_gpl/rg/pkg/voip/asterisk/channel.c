...
int ast_channel_make_compatible(struct ast_channel *chan, struct ast_channel *peer)
{
	...
	if (src_channel->lastreadformat &&
	    dst_channel->nativeformats.audio_bits & src_channel->readformat) {
		ast_log(LOG_DEBUG, "Channels are compatible. Nothing to do.\n");
		return 0;
	}
...
int ast_getstate(struct ast_channel *chan)
{
	return chan->_state;
}
...
static enum ast_bridge_result ast_generic_bridge(struct ast_channel *c0, struct ast_channel *c1,
						 ...
						 int o0nativeformats, int o1nativeformats)
{
...
retrylock:
	...
	for (/* ever */;;) {
		...
		res = ast_generic_bridge(c0, c1, config, fo, rc, nexteventts, o0nativeformats, o1nativeformats);
