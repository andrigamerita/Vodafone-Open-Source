...
static char *rg_error_level_strings[LLEVEL_MASK + 1] =
{
    "none",
    "emerg",
    "alert",
...
char *rg_error_level_str(rg_error_level_t level)
{
    return rg_error_level_strings[level & LLEVEL_MASK];
}
