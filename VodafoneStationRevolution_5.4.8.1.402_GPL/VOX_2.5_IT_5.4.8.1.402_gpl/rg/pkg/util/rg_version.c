...
char *rg_customer_version_get(void) __attribute__ ((weak));
char *rg_customer_version_number_get(void) __attribute__((weak));
...
/* return 1 iff version v is in branch b.
 * difference from rg_version_is_same_branch:
 *   rg_version_is_same_branch("1.1", "1.2") = 1
 *   rg_version_is_in_branch("1.1", "1.2") = 0
 * and
 *   rg_version_is_same_branch("1.1.1", "1.1") = 0
 *   rg_version_is_in_branch("1.1.1", "1.1") = 1
 *   rg_version_is_in_branch("1.1.1", "1") = 1
 */
int rg_version_is_in_branch(char *v, char *b)
{
    int dummy;

    return rg_version_compare_int(v, b, &dummy) == 2;
}
...
char *rg_customer_version_get(void)
{
    return NULL;
}

char *rg_customer_version_number_get(void)
{
    return NULL;
}
