...
$(call Dir_Dep,pkg/iperf,pkg/uclibc++)
$(call Dir_Dep,pkg/voip/sox,pkg/av/libmad)
ifdef CONFIG_RG_MTD_UTILS
  ifdef CONFIG_RALINK_RT3883
    $(call Dir_Dep,vendor/ralink,pkg/mtd-utils)
  endif
  ifdef CONFIG_LANTIQ_XWAY_UBOOT
    $(call Dir_Dep,vendor/lantiq/xway/u-boot,pkg/mtd-utils)
  endif
endif
...
ifeq ($(CONFIG_MIPS_BRCM)$(CONFIG_OPENRG),yy)
  ...
  $(call Dir_Dep,pkg/wps/main,vendor/broadcom/rg/wpa)
endif
