...
Get_Dir_RgLinux_To = \
  $(RG_INCLUDE_RG_LINUX_DIR)/$(sav_JMK_EXPORT_HEADERS_DIR_$(1:$2%=%))
...
# a copy of export_headers, with JMK_EXPORT_HEADERS changed to
# JMK_EXPORT_RG_LINUX_HEADERS and Get_Dir_To changed to Get_Dir_RgLinux_To
$(foreach v,\
  $(filter sav_JMK_EXPORT_RG_LINUX_HEADERS_%, $(.VARIABLES)), \
  $(eval export_rg_linux_headers:: ; \
    $(call Export_Headers,$($v), \
      $(call Get_Dir_From,$v,sav_JMK_EXPORT_RG_LINUX_HEADERS_), \
      $(call Get_Dir_RgLinux_To,$v,sav_JMK_EXPORT_RG_LINUX_HEADERS_))))
...
export_tasks = export_headers export_headers_flat export_rg_linux_headers \
