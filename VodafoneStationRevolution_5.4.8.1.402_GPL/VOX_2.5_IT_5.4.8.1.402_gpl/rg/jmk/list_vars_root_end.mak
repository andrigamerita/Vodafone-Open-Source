...
$(foreach t,$(call Abs_Path_To_Var,$(sav_JMK_MOD_TARGET)), \
  $(eval _O_OBJS_$t := $(call Mod_O_Objs,$t,3X,) $(call Mod_O_Objs,$t,26,)) \
  $(eval _OX_OBJS_$t := $(call Mod_O_Objs,$t,3X,X) $(call Mod_O_Objs,$t,26,X)) \
...
export_headers_srcs := \
  $(foreach f,$(sav_cp_JMK_EXPORT_HEADERS) \
    $(sav_cp_JMK_EXPORT_RG_LINUX_HEADERS),$(call GET_FILE_FROM_TO,$f,1))
...
# $1 - starting object name in var format (including all _pic _mod_26 etc)
...
$(foreach o,$(mod_objs), \
  $(call Define_Fix_Name_Target,$o,$(patsubst %_mod_3X.o,%.o,$(patsubst %_mod_26.o,%.o,$o))))
