...
_GET_FILE_FROM_TO=$(call JMKF_UNESCAPE_FILE_NAME,$(word $2,$(subst __, ,$1)))
GET_FILE_FROM_TO=$(if $(call IS_FROM_TO,$1),$(call _GET_FILE_FROM_TO,$1,$2),$(call JMKF_UNESCAPE_FILE_NAME,$1))
...
GET_FILE_TO=$(if $(call IS_FROM_TO,$1),$(call _GET_FILE_FROM_TO,$1,2),$(notdir $(call JMKF_UNESCAPE_FILE_NAME,$1)))
