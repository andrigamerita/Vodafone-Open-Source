...
ifdef CONFIG_RG_OS_LINUX
  ...
  # $1 - objname
  # $2 - 26 or 3X
  # The target can be *.o or *_mod_26.o or *_mod_3X.o
  GET_MOD_LINUX_CFLAGS= -D"KBUILD_STR(s)=\#s" \
   -D"KBUILD_BASENAME=KBUILD_STR($(basename $(notdir $1)))" \
   -D"KBUILD_MODNAME=KBUILD_STR($(patsubst %_mod_$2,%,$(basename $(notdir $1))))"
endif
...
ifdef CONFIG_RG_OS_LINUX
  GET_MODFLAGS=$(call DBGFR, \
    ...
    -I$(JMKE_BUILDDIR)/pkg/include -I$(RG_INCLUDE_RG_LINUX_DIR) $(dep_flags) \
    $(if $(is_mod2stat_obj_$(call Abs_Path_To_Var,$1)),,$(MODFLAGS)) \
    $(if $(filter %_mod_3X.o,$1),$(call GET_MOD_LINUX_CFLAGS,$1,3X)) \
    $(if $(filter %_mod_26.o,$1),$(call GET_MOD_LINUX_CFLAGS,$1,26)) \
...
_GET_OBJ_CFLAGS=$(call DBGFR, \
  ...
  $(if $(is_local_obj_$(call Abs_Path_To_Var,$2)), \
    ...
    $(if $(filter $2,$(sav_JMK_TARGET_CC_OBJS)), \
      $(sav_JMK_CFLAGS_$(call Abs_Path_To_Dir_Var,$2)) \
        -I$(JMKE_BUILDDIR)/pkg/include, \
...
GET_OBJ_CFLAGS=$(call DBGFR, \
  $(filter-out $(sav_JMK_CFLAGS_REMOVE_$(call Abs_Path_To_Dir_Var,$2)) \
    $(sav_JMK_CFLAGS_REMOVE_$(call Abs_Path_To_Var,$2)), \
