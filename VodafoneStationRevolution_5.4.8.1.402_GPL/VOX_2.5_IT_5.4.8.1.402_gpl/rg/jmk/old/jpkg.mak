JMK_JPKG_EXPORTED_FILES+=$(call GET_FILE_FROM,\
...
jpkg_exported=$(call JMKF_UNESCAPE_FILE_NAME,\
  $(filter-out $(JMK_DONT_EXPORT),$(JMK_JPKG_EXPORTED_FILES)))

export_to_jpkg:
	@$(RG_SHELL_FUNCS) && \
	  $(foreach f,$(strip $(jpkg_exported)),\
