...
FIX_OBJ_NAME=$(if $(call IS_SO_OBJ,$1),$($(notdir 1):%_pic.o=%.o),$(patsubst %_mod_3X.o,%.o,$(patsubst %_mod_26.o,%.o,$(notdir $1))))
...
# Change module objects from x.o to x_mod_3X.o and/or x_mod_26.o
__MOD_OBJS=$(if $(JMK_O_OBJS_$t),$(JMK_O_OBJS_$t),$(JMK_O_OBJS))
$(foreach t, $(JMK_MOD_TARGET),\
    $(eval _MOD_O_OBJS_$t:=$(strip \
        $(if $(CONFIG_RG_OS_LINUX_3X),$(__MOD_OBJS:%.o=%_mod_3X.o))\
        $(if $(CONFIG_RG_OS_LINUX_26),$(__MOD_OBJS:%.o=%_mod_26.o)))))

ifdef CONFIG_RG_OS_LINUX_3X
__MOD_3X_OBJS=$(if $(JMK_MOD_3X_O_OBJS_$t),$(JMK_MOD_3X_O_OBJS_$t),$(JMK_MOD_3X_O_OBJS))
$(foreach t,$(JMK_MOD_TARGET), \
    $(eval _MOD_3X_O_OBJS_$t:=$(__MOD_3X_OBJS:%.o=%_mod_3X.o)))
endif
...
$(foreach t,$(JMK_MOD_TARGET), $(eval \
    _O_OBJS_$t:=$(_MOD_O_OBJS_$t) $(_MOD_3X_O_OBJS_$t) $(_MOD_26_O_OBJS_$t)))
...
$(foreach t,$(JMK_MOD_TARGET), \
    ...
    $(if $(CONFIG_RG_OS_LINUX_3X),$(__MOD_OXBJS:%.o=%_mod_3X.o)) \
    $(if $(CONFIG_RG_OS_LINUX_26),$(__MOD_OXBJS:%.o=%_mod_26.o)))))

ifdef CONFIG_RG_OS_LINUX_3X
__MOD_3X_OXBJS=$(if $(MOD_3X_OX_OBJS_$t),$(MOD_3X_OX_OBJS_$t),$(MOD_3X_OX_OBJS))
$(foreach t,$(JMK_MOD_TARGET), \
    $(eval _MOD_3X_OX_OBJS_$t:=$(__MOD_3X_OXBJS:%.o=%_mod_3X.o)))
endif
...
$(foreach t,$(JMK_MOD_TARGET), $(eval \
    _OX_OBJS_$t:=$(_MOD_OX_OBJS_$t) $(_MOD_3X_OX_OBJS_$t) $(_MOD_26_OX_OBJS_$t)))
