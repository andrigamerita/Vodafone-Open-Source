...
{
    return opt_setint(L, ps, SOL_TCP, TCP_KEEPIDLE);
}

int opt_get_tcp_keepidle(lua_State *L, p_socket ps)
{
    return opt_getint(L, ps, SOL_TCP, TCP_KEEPIDLE);
}

int opt_set_tcp_keepintvl(lua_State *L, p_socket ps)
{
    return opt_setint(L, ps, SOL_TCP, TCP_KEEPINTVL);
}

int opt_get_tcp_keepintvl(lua_State *L, p_socket ps)
{
    return opt_getint(L, ps, SOL_TCP, TCP_KEEPINTVL);
}

int opt_set_tcp_keepcnt(lua_State *L, p_socket ps)
{
    return opt_setint(L, ps, SOL_TCP, TCP_KEEPCNT);
}

int opt_get_tcp_keepcnt(lua_State *L, p_socket ps)
{
    return opt_getint(L, ps, SOL_TCP, TCP_KEEPCNT);
}
