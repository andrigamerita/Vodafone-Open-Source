...
Currently available applets include:
	...
	dumpkmap, echo, egrep, eject, env, ether-wake, expr, factor, false,
	fbset, fdflush, fdformat, fdisk, fgrep, find, flock, fold, free,
	freeramdisk, fsck, fsfreeze, fstrim, fuser, getopt, getty, grep,
	gunzip, gzip, halt, hdparm, head, hexdump, hexedit, hostid,
	hostname, hwclock, i2ctransfer, ifconfig, ifdown, ifup, inetd, init,
	...
	sha256sum, sha3sum, sha512sum, shred, sleep, sort,
...
tar c|x|t [-zhvokO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [--exclude PATTERN]... [FILE]...
