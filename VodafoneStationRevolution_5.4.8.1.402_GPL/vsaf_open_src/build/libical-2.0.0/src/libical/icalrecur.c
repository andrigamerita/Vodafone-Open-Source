...
#define RRULE_PREFIX_RRULE "RRULE:"
#define RRULE_PREFIX_RRULE_LEN strlen(RRULE_PREFIX_RRULE)
...
struct icalrecurrencetype icalrecurrencetype_from_string(const char *str)
{
    ...
    if (strncasecmp(str, RRULE_PREFIX_RRULE, RRULE_PREFIX_RRULE_LEN)) {
	icalerror_set_errno(ICAL_MALFORMEDDATA_ERROR);
	return parser.rt;
    }

    /* Set up the parser struct */
    parser.rule = str + RRULE_PREFIX_RRULE_LEN;
