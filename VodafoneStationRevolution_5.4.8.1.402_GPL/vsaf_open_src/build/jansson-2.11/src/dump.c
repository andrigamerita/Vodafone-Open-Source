...
static int do_dump_integer(long long int value, json_dump_callback_t dump,
    void *data)
{
                   ...
                   hashtable_t *parents, json_dump_callback_t dump, void *data)
{
    ...
    switch(json_typeof(json)) {
        ...
        case JSON_INTEGER:
        {
            return do_dump_integer(json_integer_value(json), dump, data);
        }
        ...
        case JSON_REAL:
        {
            ...
            if ((flags & JSON_ENCODE_REAL_NO_DOT_AS_INT) &&
                (double)(long long)value == value)
            {
                return do_dump_integer(value, dump, data); 
            }
